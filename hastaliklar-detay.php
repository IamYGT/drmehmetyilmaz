...
<head>
<title><?php echo $tekil_veri_cek["proje_baslik"]; ?> - Op. Dr. Mehmet Yılmaz</title>
<meta name="description" content="<?php echo 	$tekil_veri_cek["proje_description"]; ?>">
<?php include 'css.php'; ?>
</head>
<body>
 <?php include 'ust.php'; ?>
                            ...
                            <div class="page__title-inner text-center">
                                <div class="page__title-breadcrumb">
                                        ...
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"><?php echo $tekil_veri_cek["proje_baslik"]; ?></li>
                                        </ol>
                                        </nav>
                                </div>
                            ...
                            <div class="services__details-wrapper">
                                <div class="services__details-list grey-bg-3 sidebar-wrapper mb-30">
                                    <div class="sidebar-title">
                                        <h3><?php echo LANG("Diğer Hastalıklar",$lang); ?></h3>
                                    </div>
