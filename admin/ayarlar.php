										...
										<div class="tab-content">
											...
											?>
																	<div class="col-xl-12 col-lg-12 mb-3">
																	 ...
																	 <div class="form-group row">
																			<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i>Eğitim</label>
										 ...
										 ?>
																 <div class="col-xl-12 col-lg-12 mb-3">
																	...
																	<div class="form-group row">
																		 <label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i>Deneyim</label>
										 ...
										 ?>
																 <div class="col-xl-12 col-lg-12 mb-3">
																	...
																	<div class="form-group row">
																		 <label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i>Sertifikalar</label>
																		 <textarea class="form-control ckeditor col-6"  name="sertifikalar_<?php echo $LANGUAGE_CODE; ?>"> <?php echo $row_info["sertifikalar_".$LANGUAGE_CODE]?></textarea>
